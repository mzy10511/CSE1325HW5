...
class Torso : public Robot_part {
    public:
        Torso(string name, string part_number, double weight,
                   double cost, int max_battery_slots, string description)
            : Robot_part(name, "torso", part_number, weight, cost, description),
              _max_battery_slots{max_battery_slots} { }
