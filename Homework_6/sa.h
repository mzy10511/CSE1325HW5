...
class Sales_associate {
    public:
        Sales_associate(string name, string employee_number)
            : _name{name}, _employee_number{employee_number} { }

        string name() const;
        string employee_number() const;

        friend ostream& operator<<(ostream& os, const Sales_associate& sales_associate);
    protected:
        string _name;
